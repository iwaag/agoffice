...
CLIENT_ID = os.getenv("CLIENT_ID", "agoffice")
KEYCLOAK_URL = os.getenv("KEYCLOAK_URL", "http://localhost:8080")
KEYCLOAK_REALM = os.getenv("KEYCLOAK_REALM", "agoffice")
...
AGOFFICE_API_URL = os.getenv("AGOFFICE_API_URL", "http://set_agoffice_url:8080")
